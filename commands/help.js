    ...
    execute(message, args){
        ...
        switch(args[0]){
            ...
            case 'learn':
                ...
                var helpEmbed = new Discord.MessageEmbed()
                    .addFields(
                        { name: `Learn`, value: `Command unlocked in area 2 used to learn and gain experience. User picks what category they want experience in, player xp, gathering, or artisan. A question is then given to the user, if they answer correctly, they gain experience in the chosen category.`},
